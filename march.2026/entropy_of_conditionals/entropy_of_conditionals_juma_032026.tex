...
While this is ultimately not a necessarily unique formulation, in the wider context of application to conditional observations and antecedent entropy it poses a useful metric by which to engineer systems such as SPC learning mechanisms.

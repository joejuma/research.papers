...
\section{Conclusion}
Herein I've formulated (what appears to be) a new metric of observation-based context entropy measurement, which I'll denote as Juma Antecedent Entropy or Observed Context Entropy, $\beta_{J}(y,X)$.\

\begin{equation}
    \beta_{J}(y,x,Y) = log_{2}(\#X) - log_{2}(P(y|x)^{-1})
\end{equation}

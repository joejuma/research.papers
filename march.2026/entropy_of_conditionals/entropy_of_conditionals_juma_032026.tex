...
First, Claude Shannon defined **Shannon information** or **surprisal** (aka “information content” or “self-information”) which may be thought of as “how surprising a certain outcome is”. This is the formula,
...
Second, there’s **Point-Wise Mutual Information** (PMI) the deviation in bits of a conditional event occurring to the event occurring independently. This concept was introduced by Robert Faro in 1961. This is only vaguely the same as what I’ve measured.
...
Another related metric is the kullback-leibler divergence (KL divergence) which is a statistical distance metric between two probability distributions (e.g. $P$, $Q$) defined on the same sample space $X$.
